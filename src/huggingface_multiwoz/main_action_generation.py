...
def main(args):
    ...
    """
    # Load the dataset
    dataset = MultiWOZDatasetActionGeneration(tokenizer_name=args.tokenizer_name,
    ...
    if args.train_model:
        ...
        trained_model_path = train(dataset=dataset,
...
if __name__ == "__main__":
    ...
    parser.add_argument("--strategy", type=str, default='epoch',
                        ...
                        choices=['steps', 'epoch'])
    parser.add_argument("--metric_for_best_model", type=str, default='f1-score_weighted',
                        help="Metric to monitor for early stopping and saving the best model.",
                        choices=['precision_micro', 'recall_micro', 'f1-score_micro', 'precision_macro', 'recall_macro',

...
from huggingface_multiwoz_dataset import MultiWOZDatasetAllGeneration
...
def main(args):
    ...
    """
    # Load the dataset
    all_dataset = MultiWOZDatasetAllGeneration(tokenizer_name=args.tokenizer_name,
    ...
    if args.train_model:
        ...
        trained_model_path = train(dataset=all_dataset,
    ...
    # evaluate(dataset=all_dataset, model_path=trained_model_path, max_target_length=args.max_target_length, )
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_root_path", type=str,
                        default="/home/safarjar/HCN/models/all_generation",
    ...
    parser.add_argument("--train_subset_size", default=1.0, type=float, help="Size of the subset of train data to use")

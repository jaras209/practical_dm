...
def evaluate(multiwoz_dataset: MultiWOZDatasetActionsClassification, model_path: Path, top_k: int = 5,
             only_dataset: str = None):
    """
    Evaluate the model on the datasets in multiwoz_dataset.

    Args:
        multiwoz_dataset (MultiWOZDatasetActionsClassification): The dataset object containing the dataset and tokenizer.
